...
SET defaulttarget=%LOCALAPPDATA%\Temp\PQds
IF "%remote%" == "" SET remote=git@github.com:GridProtectionAlliance/EPRI-PQDS.git
...
SET gsfdependencies=%target%\src\Dependencies\gsf
